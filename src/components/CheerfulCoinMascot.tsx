...
/**
 * Same build & colors as NeutralCoinMascot: ^_^ eyes, arms up, jump loop.
 */
    ...
    >
      ...
      >
        ...
        >
          ...
          {/* arms up — cheering (shorter than full reach) */}
          <path d="M 23 54 Q 19.5 49 17.5 43" fill="none" stroke={RIM_OUTLINE} strokeWidth="2.1" strokeLinecap="round" />
          <path d="M 87 54 Q 90.5 49 92.5 43" fill="none" stroke={RIM_OUTLINE} strokeWidth="2.1" strokeLinecap="round" />
          <circle cx="15.2" cy="40.5" r="3.85" fill={RIM_FILL} stroke={RIM_OUTLINE} strokeWidth="0.75" />
          <circle cx="94.8" cy="40.5" r="3.85" fill={RIM_FILL} stroke={RIM_OUTLINE} strokeWidth="0.75" />
        </svg>
      </motion.div>
    </div>
  );
